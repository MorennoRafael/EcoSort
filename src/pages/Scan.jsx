    ...
    "
      ...
      {showQR && (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          {/* modal */}
          <div className="relative bg-white rounded-3xl shadow-2xl w-[92%] md:w-[420px] p-6 text-center">
            ...
            <p className="text-sm text-gray-500 mt-1">
              Scan kode QR pada mesin bank sampah
            </p>
            ...
            <p className="text-xs text-gray-400 mt-2">
              Setelah scan berhasil klik tombol di bawah
            </p>
